                ...
                <div className="container mx-auto px-4 pt-4">
                    <div className="flex flex-wrap items-center gap-4 sm:gap-8 md:gap-24 lg:gap-48 ">
                        ...
                        <div className="flex items-center justify-center sm:ml-auto gap-4 sm:gap-6 md:gap-4 p-2 sm:p-4 lg:pr-16 flex-wrap">
                            <svg
                                className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 border-2 border-pink-300 text-white"
                                aria-hidden="true"
                        ...
                        <div className="p-4 md:p-6 lg:p-4 lg:pl-16">
                            ...
                            <ul className="space-y-4">
                                <li className="flex items-start gap-4">
                                    ...
                                    <span className="text-gray-300">Mariendalsvej 50D 2 2000 Frederiksberg</span>
                                </li>
                                <li className="flex items-start gap-4">
                                ...
                                <li className="flex items-start gap-4">
                                    ...
                                    <a href="tel:+221234567900" className="text-gray-300 hover:text-white">
                                        (+22) 123 - 4567 - 900
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div className="border-t border-gray-800 mb-2 py-6 text-center">
