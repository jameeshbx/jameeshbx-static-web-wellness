      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative rounded-32 mx-auto overflow-hidden mb-8 sm:mb-12 md:mb-16">
          <div className="bg-purple grid grid-cols-1 lg:grid-cols-12 min-h-400">
            ...
            <div className="relative lg:col-span-5 h-64 sm:h-80 md:h-full lg:h-full sm:m-8 lg:m-16 pl-16 mt-11 m-8 sm:m-16">
            <div className="absolute left-4 sm:left-8 top-6 sm:top-12 flex space-x-2 sm:space-x-4">

      <div className="w-3 sm:w-6 md:w-12 lg:w-16 h-80 sm:h-160 md:h-212 lg:h-280 bg-white rounded-full" />
      <div className="w-3 sm:w-6 md:w-12 lg:w-16 h-100 sm:h-200 md:h-280 lg:h-360 bg-white rounded-full" />
</div>


              <div className="absolute z-10 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 lg:left-36 lg:translate-x-0">
              
                <div className="w-52 h-52 sm:w-36 sm:h-36 md:w-40 md:h-40 lg:w-52 lg:h-52 rounded-full overflow-hidden border-4 border-white mb-8 sm:mb-14 mr-8 sm:mr-16 ">
            ...
            <div className="lg:col-span-7 p-6 sm:p-8 md:p-12 lg:p-20 relative lg:-ml-28 m-5 sm:m-8 lg:-ml-6 -mt-9">
              ...
              <div className="mt-12 sm:mt-16 md:mt-24 space-y-4 sm:space-y-6 text-white max-w-2xl">
                <div className="space-y-1 sm:space-y-2">
                  <h3 className="text-xl sm:text-2xl md:text-3xl font-Manrope">Leslie Alexander</h3>
                  <p className="text-tertionary text-base sm:text-lg">Moncton, Canada</p>
                </div>
        ...
        <div className="flex justify-center gap-4 mt-6 sm:mt-8">
          <button className="w-10 h-10 sm:w-12 sm:h-12 rounded-full border border-purple bg-white flex items-center justify-center hover:shadow-lg transition-shadow">
          ...
          <button className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-purple flex items-center justify-center hover:shadow-lg transition-shadow">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="sm:w-6 sm:h-6">
